...
public:
	...
	void invokeRead()
	{
		async_read(socket_,
			...
			boost::bind(&BoostLineClient::handle_read_body, this,
...
private:
	...
	void handle_read_body(const boost::system::error_code& error)
	{
		if (!error)
		{
			...
			boost::asio::async_read(socket_,
				boost::asio::buffer(read_msg_.data(), read_msg_.length()),
				boost::bind(&BoostLineClient::handle_read_header, this,
					boost::asio::placeholders::error));
			/*socket_.async_read_some(boost::asio::buffer(read_msg_.data(), read_msg_.length()), boost::bind(&line_client::handle_read_header, this,
				boost::asio::placeholders::error));*/
